...
function insertBoard(boardTitle) {
	...
	var newBoard = '<div class="col-3 board-selection-container" data-boardName="board-item-' + numBoards +'" id="last-board"><a href="#" class="btn btn-primary btn-lg btn-block board-item" role="button">' + boardTitle + '</a></div>';
